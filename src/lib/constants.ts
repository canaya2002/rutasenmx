...
export const PLACE_CATEGORIES = [
  ...
  { slug: 'sitios-inah', name: 'Sitios INAH', icon: 'building', color: '#B45309', emoji: '\uD83C\uDFDB\uFE0F', iconSvg: '/icon/INAHicon.svg' },
  ...
  { slug: 'cenotes', name: 'Cenotes', icon: 'droplets', color: '#06B6D4', emoji: '\uD83D\uDCA7', iconSvg: '/icon/cenoteicon.svg' },
